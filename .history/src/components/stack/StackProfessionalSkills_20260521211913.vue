<script setup>
import profSkillsStacks from "@/data/prof-skills-stack.json";
...
<style scoped>
.stack-professional-skill-mini-ctn{
    margin-top:20px;
    display:flex;
    flex-direction: row;
    flex-wrap: wrap;
...
.stack-professional-skill-main-ctn-title{
    ...
    padding: 2vh 0;
    margin-bottom: 8vh;
    border-top: 0.1vh solid hsl(166, 91%, 49%);  
